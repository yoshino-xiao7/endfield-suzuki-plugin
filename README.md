...
基于 [Endfield Cloud](https://endfield.suzuki.ink) 的 Yunzai-Bot **终末地**助手插件 · 绑定 / 签到 / 角色查询 / Wiki 百科 / 基建 / 抽卡统计 / 理智提醒
...
- 支持 Token / 手机验证码绑定，支持每日自动签到、凭证自动刷新、角色信息查询、Wiki 百科查询、基建查询、抽卡记录统计、理智溢出提醒、每日任务提醒
...
| `#终末地wiki <关键词>` / `#终末地百科 <关键词>` | 搜索 Wiki 条目 |
| `#终末地wiki目录` / `#终末地百科目录` | 查看 Wiki 目录和分类 |
| `#终末地wiki详情 <条目ID或名称>` / `#终末地百科详情 <条目ID或名称>` | 查询指定 Wiki 条目详情 |
| `#终末地wiki语音 <干员名> [中文/日语/英语/韩语/全部]` | 下载并发送干员语音文件 |
| `#终末地wiki mv <干员名>` | 下载可用 MV/演示文件，若接口仅提供页面链接则返回链接 |
...
│   ├── domain.html          # 领地基建卡模板
│   ├── wiki-list.html       # Wiki 搜索结果模板
│   ├── wiki-detail.html     # Wiki 条目详情模板
...
- 🖼️ **丰富卡片**：资料卡、角色详情卡、Wiki 百科卡、帝江号卡、领地基建卡、抽卡统计图表（全部图片渲染）
